...
public class LecturerMethods implements Repository{
    ...
    public boolean insert() {
        sql = "insert into lecturers values(?,?,?)";
    ...
    public boolean check() {
        sql = "select lecturer_id, password from lecturers where lecturer_id = ? and password = ?";
