...
public class AssignForLecturer extends javax.swing.JFrame {

    public AssignForLecturer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("\"Assign Subjects For Lecturers\" ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssignForLecturer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
