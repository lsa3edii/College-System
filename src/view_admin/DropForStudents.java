...
public class DropForStudents extends javax.swing.JFrame {

    public DropForStudents() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("\"Drop Subjects For Students\" ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DropForStudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
